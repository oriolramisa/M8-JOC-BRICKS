...
class _EasyScreenState extends State<MediumScreen> {
  //variables pilota
  double ballX = 0;
  double ballY = 0;
  double ballXincrements = 0.007;
  double blalYincrements = 0.007;
  ...
  void _playFile() async {
    soundPlayer = await cache.loop('Sound2.wav'); // assign player here
  }
